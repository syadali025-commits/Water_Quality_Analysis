        ...
        <div className="results-highlight">
          ...
          <div className={`result-card ph-result ${results.pHStatus?.toLowerCase()}`}>
            ...
            <div className="result-content">
              ...
              <div className="result-value-large">
                {results.pH !== null ? results.pH : 'N/A'}
              </div>
              ...
              {results.waterContribution && (
                <div className="water-contribution-note">
                  ...
                  <span className="note-text">
                    Water contribution (1×10⁻⁷) added to H+ concentration
                  </span>
                </div>
              )}
            </div>
          ...
          <div className="secondary-results">
            ...
            <div className="result-card">
              ...
              <div className="result-content">
                <div className="result-value-medium">
                  {results.salinity !== null ? `${results.salinity} ppt` : 'N/A'}
                </div>
    </div>
  </div>
)}
...
{showResults && (
  <div className="results-highlight">
    ...
    <div className="secondary-results">
      ...
      <div className="result-card">
        <div className="result-header">
          <span className="result-icon">OH</span>
          <h4>Alkalinity</h4>
        </div>
        <div className="result-content">
          <div className="result-value-medium">
            {results.alkalinity !== null ? `${results.alkalinity} mg/L` : 'N/A'}
          </div>
